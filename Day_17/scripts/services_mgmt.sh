...
if whiptail --title "SSH-Sicherheits-Härtung" \
    ...
    whiptail --title "SSH Gehärtet" --msgbox "Der SSH-Server wurde erfolgreich gehärtet und neu gestartet!" 8 45
fi
